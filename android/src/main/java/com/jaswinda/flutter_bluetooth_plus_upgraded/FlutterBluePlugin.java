...
package com.jaswinda.flutter_bluetooth_plus_upgraded;
...
public class FlutterBluePlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, RequestPermissionsResultListener  {
    ...
    private static final String NAMESPACE = "plugins.jaswinda.com/flutter_bluetooth_plus_upgraded";
    ...
    public boolean onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_FINE_LOCATION_PERMISSIONS) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                pendingResult.error(
                        "no_permissions", "flutter_bluetooth_plus_upgraded plugin requires location permissions for scanning", null);
                pendingResult = null;
                pendingCall = null;
            }
            return true;
